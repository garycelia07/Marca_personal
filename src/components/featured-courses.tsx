        ...
        <section className="border-t hairline bg-[var(--background)]">
            <div className="mx-auto max-w-[1440px] px-5 py-12 sm:px-8 lg:px-12 lg:py-16">
                <div className="mb-8 flex flex-col gap-6 border-b hairline pb-6 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <p className="eyebrow text-[0.8rem] tracking-[0.16em] sm:text-sm">Escuela de Liderazgo</p>
                        <h2 className="display-font mt-5 max-w-2xl text-4xl leading-[0.98] tracking-tight sm:text-6xl">Cursos que transforman <em className="script-font text-[var(--copper)]">tu perspectiva.</em></h2>
                    </div>
