    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-label={title}>
            ...
            <div className="relative w-full max-w-md overflow-hidden rounded-2xl border hairline bg-[var(--paper)] p-6 shadow-[0_24px_48px_-18px_rgba(36,35,31,0.6)] sm:p-8">
                ...
                <h3 className="display-font mt-4 text-3xl leading-none text-[var(--danger)]">{title}</h3>
                <p className="mt-3 text-sm leading-6 text-[var(--ink-soft)]">
                    ¿Seguro que quieres eliminar {entityName} <span className="font-semibold">{detail}</span>? Esta acción no se puede deshacer.
                </p>
